chrome.webRequest.onBeforeRequest.addListener(
  function(details) {
    console.log(details);
    var amazonUS = "https://www.amazon.com";
    ...
    if (details.url == "https://www.amazon.co.uk/" || details.url == "https://www.amazon.com/gp/homepage.html") {
      ...
      return {
        redirectUrl: charity.url
      };
    };

    if (details.url.indexOf(amazonUS) > -1 && details.url.length <= amazonUS.length + 1) {

      var notifyOptions = {
        type: "basic",
        title: "Donating via Amazon Smile",
        message: "When you sign in and purchase, money will be donated from it via Amazon Smile. Go you!",
        iconUrl: "icons/icon48.png"
      }

      chrome.notifications.create(notifyOptions);

      var currentURL = details.url.toString();
      var newURL = currentURL.replace("https://www.amazon.com", "https://smile.amazon.com")
